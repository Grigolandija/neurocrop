...
assert(runtime.includes('function calculateCenteredMovingAverage(') && runtime.includes('function getTrendDisplayValuesForMetric(') && runtime.includes('data-trend-presentation'), "Trend charts must support a raw and moving-average presentation without changing source measurements");
