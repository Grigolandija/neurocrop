...
assert(runtime.includes('overview-area-card-grid') && runtime.includes('data-overview-section-card') && runtime.includes('Farm at a glance') && runtime.includes('const sectionCard = event.target.closest("[data-overview-section-card]")'), "Overview must provide a compact clickable Area and Section growing-status map");
