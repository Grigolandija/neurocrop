...
assert(apiFacade.includes('getActionHistory:') && runtime.includes('today-priority-history') && runtime.includes('Verified from sensor readings'), "Recent action history must expose sensor-verified outcomes");
