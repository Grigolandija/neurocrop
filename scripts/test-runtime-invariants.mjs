...
assert(runtime.includes('data-profile-editor-section="${escapeAttribute(section.id)}"') && runtime.includes('class="range-editor crop-profile-metric-row"') && runtime.includes('data-profile-critical-output readonly'), "Crop profile editing must use the frontend-redesign section navigation and three-column range editor without making derived critical limits editable");
