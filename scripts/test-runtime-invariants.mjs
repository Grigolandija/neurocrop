...
assert(markup.includes('class="nav-group-label">Daily work</p>') && markup.includes('class="nav-group-label nav-group-label-spaced">System setup</p>') && markup.includes('data-sidebar-action="alerts" data-active="false" hidden disabled'), "Primary navigation must separate daily work from setup and hide the unreleased Alerts route");
