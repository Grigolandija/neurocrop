...
CREATE UNIQUE INDEX IF NOT EXISTS idx_areas_org_id_unique ON areas (organization_id, id);
...
CREATE INDEX IF NOT EXISTS idx_push_subscriptions_organization ON push_subscriptions (organization_id);
...
CREATE INDEX IF NOT EXISTS idx_push_deliveries_delivered ON push_deliveries (delivered_at);
