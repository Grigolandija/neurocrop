...
AS $$
  SELECT '{
    ...
    "lux":{"label":"Light","unit":"lx","decimals":0,"optimal":[10000,35000],"warning":[5000,45000],"critical":[0,60000],"lightingSchedule":{"enabled":false,"start":"06:00","end":"22:00","timeZone":"Europe/Vilnius","darkThresholdLux":100}}
  }'::jsonb;
$$;
