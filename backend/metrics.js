...
export const METRIC_UNITS = {
  ...
  soilEc: 'mS/cm', leafTemp: '°C', waterTemp: '°C', airPressure: 'hPa',
...
export const METRIC_TO_COLUMN = {
  ...
  airPressure: 'air_pressure', batteryLevel: 'battery_percent',
};
export const METRIC_INTERVAL_SEC = {
  ...
  leafTemp: 600, waterTemp: 600, airPressure: 600, batteryLevel: 21600,
};
