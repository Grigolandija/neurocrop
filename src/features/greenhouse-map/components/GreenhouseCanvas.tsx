...
const translucent = (color: string, alpha: number) => {
  ...
  return match
    ? `rgba(${Number.parseInt(match[1], 16)}, ${Number.parseInt(match[2], 16)}, ${Number.parseInt(match[3], 16)}, ${alpha})`
