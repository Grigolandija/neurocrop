...
const authTranslations: Record<string, string> = {
  ...
  'Workspace request pending': 'Darbo aplinkos prašymas laukia patvirtinimo',
  'Workspace request declined': 'Darbo aplinkos prašymas atmestas',
  'Account connection required': 'Reikia susieti paskyrą',
  'Your workspace request is awaiting administrator approval.': 'Jūsų darbo aplinkos prašymas laukia administratoriaus patvirtinimo.',
  'Your workspace request was not approved.': 'Jūsų darbo aplinkos prašymas nebuvo patvirtintas.',
  'Use the same verified email address as your existing NeuroCrop account.': 'Naudokite tą patį patvirtintą el. pašto adresą kaip esamoje „NeuroCrop“ paskyroje.',
